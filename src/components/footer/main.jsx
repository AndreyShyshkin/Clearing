          ...
          <div className="footerBlocks">
            <div className="footerMenu">
              <div>
                ...
                <ul>
                  <li>
                    <a href="/pages/services/">Послуги</a>
                  </li>
                  <li>
                    <a href="/pages/calculator/">Вартість</a>
                  </li>
                  <li>
                    <a href="/pages/fqa/">Питання</a>
                  </li>
                  <li>
                    <a href="/pages/contactus/">Контакти</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul>
                  <li>
                    <a href="/">Прибирання квартир та будинків</a>
                  </li>
                  <li>
                    <a href="/pages/office/">Прибирання офісів та ресторанів</a>
                  </li>
                  <li>
                    <a href="/pages/afterrenovation/">
            ...
            <div className="footerContactBlock">
              <div>
                ...
                <ul className="contactFooter">
                  ...
                  <li>
                    <a href="/pages/contactus/">+48 534 517 801</a>
                  </li>
                  <li>
                    <a href="/pages/contactus/">пошта</a>
                  </li>
                  <li>
                    <a href="/pages/contactus/">адреса</a>
                  </li>
                </ul>
              </div>
