      ...
      <div className="banner1">
        <div className="banner1Container">
          <div className="banner1Right">
            ...
            <ul>
              <li>
                <div className="circle"></div>1 генеральне прибирання
              </li>
              <li>
                <div className="circle"></div>1 базове прибирання
              </li>
            </ul>
            <div className="valentinBlock">
              <img src={valentin} alt="valentin" />
              <p>
                Хімчистка стільців, диванів, матраців, подушок та крісел раз у 6
                місяців у подарунок!
              </p>
            </div>
          </div>
