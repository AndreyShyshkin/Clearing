    ...
    <>
      <div className="blocks4">
        <div className="block4">
          ...
          <p>
            KARCHER — це професійна техніка, що забезпечує ретельне та якісне
            прибирання. Весь інвентар та техніки наші клінери приносять з собою!
          </p>
        </div>
        <div className="block4">
          ...
          <p>
            ...
            KIEHL та Pomoc Domowa. Наші миючі засоби не мають різких запахів та
            гіпоалергенні
          </p>
        </div>
        <div className="block4">
          ...
          <p>
            Всі наші клінери спеціально підготовленні та пройшли навчання від
            нашої компанії. Ми збираємо відгуки про кожного працівника та
            контролюємо їх роботу
          </p>
        </div>
      </div>
    </>
