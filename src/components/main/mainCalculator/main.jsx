  ...
  const handleServiceClick = (service, servicePrice) => {
    ...
    if (serviceIndex !== -1) {
      setSelectedServices((prevSelectedServices) =>
        prevSelectedServices.filter((_, index) => index !== serviceIndex)
      );
            ...
            <div className="calculatorBlock">
              <div className="calculator-form">
                ...
                <div className="Size">
                  ...
                  <div className="area">
                    <div
                      className={`minus ${areaSize > 1 ? "largerArea" : ""}`}
                      onClick={handleMinusClick}
                    >
                      <p>-</p>
                    </div>
                    <div className="areaSize">
                      <span>{areaSize}</span> м²
                    </div>
                ...
                <div className="services">
                  ...
                  <div
                    onClick={() =>
                      handleServiceClick("Миття вікон (стандартні)", 35)
                    }
                  >
                    <div className="checkbox">
                      <img src={getServiceImage("Миття вікон (стандартні)")} />
                    </div>{" "}
                    <p>Миття вікон (стандартні) - 35zł</p>
                  </div>
                  <div
                    onClick={() =>
                      handleServiceClick("Миття вікон (до підлоги)", 40)
                    }
                  >
                    <div className="checkbox">
                      <img src={getServiceImage("Миття вікон (до підлоги)")} />
                    </div>{" "}
                    <p>Миття вікон (до підлоги) - 40zł</p>
                  </div>
                  {currentPage !== "/pages/calculator/" &&
                  currentPage !== "/pages/calculator" &&
                  currentPage !== "/pages/calculator/index.html" ? (
                    <>
                      <div
                        onClick={() => handleServiceClick("Мікрохвильовка", 15)}
                      >
                        <div className="checkbox">
                          <img src={getServiceImage("Мікрохвильовка")} />
                        </div>{" "}
                        <p>Мікрохвильовка - 15zł</p>
                      </div>
                      <div
                        onClick={() => handleServiceClick("Холодильник", 40)}
                      >
                        <div className="checkbox">
                          <img src={getServiceImage("Холодильник")} />
                        </div>{" "}
                        <p>Холодильник - 40zł</p>
                      </div>
                      <div onClick={() => handleServiceClick("Плита", 35)}>
                        <div className="checkbox">
                          <img src={getServiceImage("Плита")} />
                        </div>{" "}
                        <p>Плита - 35zł</p>
                      </div>
                      <div
                        onClick={() =>
                          handleServiceClick("Хімчистка офісних стільчиків", 20)
                        }
                      >
                        <div className="checkbox">
                          <img
                            src={getServiceImage(
                              "Хімчистка офісних стільчиків"
                            )}
                          />
                        </div>{" "}
                        <p>Хімчистка офісних стільчиків - 20zł</p>
                      </div>
                      <div
                        onClick={() =>
                          handleServiceClick("Хімчистка дивану 2х", 109.99)
                        }
                      >
                        <div className="checkbox">
                          <img src={getServiceImage("Хімчистка дивану 2х")} />
                        </div>{" "}
                        <p>Хімчистка дивану 2х - 109,99zł</p>
                      </div>
                      <div
                        onClick={() =>
                          handleServiceClick("Хімчистка дивану 3х", 129.99)
                        }
                      >
                        <div className="checkbox">
                          <img src={getServiceImage("Хімчистка дивану 3х")} />
                        </div>{" "}
                        <p>Хімчистка дивану 3х - 129,99zł</p>
                      </div>
                      <div
                        onClick={() =>
                          handleServiceClick("Хімчистка дивану 4х", 149.99)
                        }
                      >
                        <div className="checkbox">
                          <img src={getServiceImage("Хімчистка дивану 4х")} />
                        </div>{" "}
                        <p>Хімчистка дивану 4х - 149,99zł</p>
                      </div>
                    </>
                  ) : null}
                </div>
                ...
                <div className="yourInfo">
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      placeholder="На коли хочете прибирання?"
                      {...register("date", { required: true })}
                    />
                    <input
                      type="time"
                      placeholder="На котру годину?"
                      {...register("time", { required: true })}
                    />
                    <input
                      type="text"
                      placeholder="Ваша повна адреса (включаючи номер будинку та квартиру)"
                ...
                <div className="confirm">
                  <div onClick={confidentialityClick}>
                    ...
                    <p>
                      Оформлюючи замовлення я погоджуюсь{" "}
                      <a href="#">
                        з договором публічної оферти та політикою
                        конфіденційності
                      </a>
                    </p>
                  </div>
                  <div onClick={personalDataClick}>
                    ...
                    <p>
                      Я даю згоду для використання моїх особистих данних в цілях
                      відправки підписки та акційних пропозицій
                    </p>
                  </div>
                </div>
                <div className="pay">
                ...
                <div className="sell10 sell10FullScreen">
                  ...
                  <p className="first">
                    *вкажіть що це ваше перше замовлення у полі з коментарем
                  </p>
                </div>
              </div>
