      ...
      <div className="afterRenovatio">
        <div className="container">
          <div className="mainScreen">
            <h1>Прибирання приміщень після ремонту у Лодзі</h1>
            <h2 className="info">
              Усунемо наслідки ремонту будь-якох складності та підготуємо
              приміщення для вашого переїзду! Попередня вартість прибирання 5zł
              за м²
            </h2>
