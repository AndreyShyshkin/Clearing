      ...
      <div className="office">
        <div className="container">
          <div className="mainScreen">
            <h1>Прибирання офісів та ресторанів у Лодзі</h1>
            <h2 className="info">
              Професійний клінінг для офісних приміщень та ресторанів від
              компанії Comfort Group. Попередня вартість прибирання 2zł за м².
            </h2>
            <ul>
              <li>
                <div className="circle"></div>Офісні приміщення
              </li>
              <li>
                <div className="circle"></div>Магазини
              </li>
              <li>
                <div className="circle"></div>Ресторани
              </li>
            </ul>
